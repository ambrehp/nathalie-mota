// gestion de la Lightbox sur la page d'acceuil
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function recupArrayPhp() {
    ...
    // Parcour des données pour récupérer les éléments de chaque photo
  ...
  (function ($) {
    $(document).ready(function () {
      ...
      // On affichage la photo et les info souhaitées
      $.changePhoto = function () {
        ...
        $.ajax({
          ...
          success: function (res) {
            // Réponse ok on retire l'image de chargement
  ...
  // // Gestion de la Lightbox sur les photos de single-photo
